...
Nhiệm vụ: Viết chương trình đếm xem có bao nhiêu số chia hết cho X trong khoảng từ A đến B, với A≤BA \leq BA≤B, và X là một số nguyên dương.
Ví dụ: Nếu A=1A = 1A=1, B=50B = 50B=50, và X=5X = 5X=5, thì có 10 số chia hết cho 5: 5,10,15,…,505, 10, 15, \dots, 505,10,15,…,50.
...
Ví dụ: Nếu M=5M = 5M=5, tích là 1×2×3×4×5=1201 \times 2 \times 3 \times 4 \times 5 = 1201×2×3×4×5=120.
...
Nhiệm vụ: Viết chương trình nhận ba số nguyên A, B, và X (A<BA < BA<B), đếm bao nhiêu số trong khoảng từ A đến B (bao gồm cả A, B) chia hết cho X.
Ví dụ: Với A=1,B=10,X=2A = 1, B = 10, X = 2A=1,B=10,X=2, có 5 số chia hết cho 2: 2,4,6,8,102, 4, 6, 8, 102,4,6,8,10.
